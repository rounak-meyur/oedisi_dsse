...
def extract_baseVoltages(bus: dict, voltages: VoltagesMagnitude) -> dict:
...
def extract_info(topology: Topology) -> Tuple[dict, dict]:
    ...
    bus_info = extract_baseVoltages(bus_info, topology.base_voltage_magnitudes)
